...
`configs/models.yaml` shall declare providers and models. Each provider entry shall specify `base_url`, `api_key_env`, rate-limit parameters, and a list of supported model identifiers. Each model entry shall specify token-cost rates.
